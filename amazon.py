dic_admin = {"sasi": "123"}
dic_vendor = {"prdee": "1234"}
vendor_proposal={"selva": "A"}
dic_user = {"devaraja": "000"}
n=1
vendor_lst={}
original_vendor=["siva"]
phone = {"redmi 7": 27000, "iphone 10": 120000,"realme 7i":30000}
laptop = {"infinix": 35000, "sony": 60000,"asus rog":70000}
items=[phone,laptop]
while(n>=1):
    print("********************** AMAZON ******************************")
    print("1.admin\n2.vendor\n3.user")
        ...
        if (user_choice == 1):
            ...
            while (loop == True):
                ...
                if ((user_name, user_password) in dic_user.items()):
                    ...
                    vendor_lst.update({user_name:user_password})
                    loop = False
        elif (user_choice == 2):
            user_name = str(input("enter the name:"))
            user_password = str(input("enter the password:"))
